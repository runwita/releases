...
This repo hosts the public release artefacts for [Runwita](https://runwita.com) — the macOS app DMG, zip, and the `latest-mac.yml` manifest that powers in-app auto-updates.
